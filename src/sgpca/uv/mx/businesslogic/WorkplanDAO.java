...
public class WorkplanDAO implements IWorkplan{
    ...
    private static final String SQL_SELECTINFO = "SELECT * FROM tbl_plantrabajo WHERE idPlanTrabajo = ?;";
    ...
    public Workplan selectInfo(int idWorkplan){
        ...
        if(connect != null){
            try{
                preStatement = connect.prepareStatement(SQL_SELECTINFO);
                ...
                if(rSet.next()){
                    ...
                    workPlan.setIdWorkplan(rSet.getInt("idPlanTrabajo"));
                    workPlan.setTitle(rSet.getString("titulo"));
                    Date startDate = rSet.getDate("fechaInicio");
