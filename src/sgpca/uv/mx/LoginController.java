...
import sgpca.uv.mx.utilities.EmailValidation;
    ...
    private void loginMethod(){
        ...
        if(!emailID.isEmpty() && !passwordID.isEmpty()){
            if(EmailValidation.isValid(emailID)){
                ...
                if(memberInfo.select(emailID, passwordID).getEmail() == null && memberObject.getPassword() == null){
                ...
                else if(memberInfo.select(emailID, passwordID).getEmail().equals(emailID) && memberObject.getPassword().equals(passwordID)){    
